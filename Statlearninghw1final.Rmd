...
kmeans_result_seven = kmeans(Rent_factor_data, centers = 3)
...
# Add a 'cluster' column to represent cluster number
cluster_centers$cluster <- as.factor(1:nrow(cluster_centers))

# Exclude the 'cluster' column from the heatmap data
cluster_centers_numeric <- cluster_centers[, -ncol(cluster_centers)]  # Remove the last column (cluster)

# Create heatmap of cluster centers (only numeric columns)
