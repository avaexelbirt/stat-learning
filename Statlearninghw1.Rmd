...
Rent_price$dbscan_cluster <- as.factor(dbscan_result$cluster)

ggplot(Rent_price, aes(x = beds, y = price, color = dbscan_cluster)) +
  geom_point(size = 1) +
...
Rent_price$gmm_cluster <- as.factor(gmm_result$classification)

ggplot(Rent_price, aes(x = beds, y = price, color = gmm_cluster)) +
  geom_point(size = 1) +
